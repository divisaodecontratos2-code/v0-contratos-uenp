    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-slate-50 py-8">
        <div className="container mx-auto max-w-4xl px-4">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-slate-900">Importar Contratos</h1>
            <p className="mt-2 text-slate-600">
              Importe contratos em lote através de arquivo CSV, URL ou colando os dados diretamente
            </p>
          </div>
